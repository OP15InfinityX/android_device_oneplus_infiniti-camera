...
PRODUCT_COPY_FILES += \
    ...
    $(OPLUS_CAMERA_PATH)/configs/permissions/privapp-permissions-oplus-product.xml:$(TARGET_COPY_OUT_PRODUCT)/etc/permissions/privapp-permissions-oplus-product.xml \
